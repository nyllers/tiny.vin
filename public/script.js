...
function createCopyIconButton() {
  ...
  button.innerHTML = `<svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <g stroke-width="2.6">
      <path d="M10.922 12.654a2.744 2.78 0 0 0 4.137.3l1.647-1.668a2.744 2.78 0 0 0-3.88-3.932l-.944.95" style="stroke-width:1.4363" transform="matrix(.76 0 0 .76 6.4 6.4)"></path>
      <path d="M13.117 11.542a2.744 2.78 0 0 0-4.137-.3L7.333 12.91a2.744 2.78 0 0 0 3.88 3.932l.938-.951" style="stroke-width:1.4363" transform="matrix(.76 0 0 .76 6.4 6.4)"></path>
    </g>
  </svg>`;
  return button;
}
